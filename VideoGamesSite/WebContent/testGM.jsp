...
try{
	Class.forName("com.mysql.jdbc.Driver");
		...
		String sql = "Select * FROM games WHERE games.titre='Guacamelee! 2'";
...
<body>
	...
	<center><h1>Guacamelee! 2</h1></center>
	
	
	
	<div id="tests">
		<ul>
			<li><img src="images/Guacamelee2.jpg" width=600px height=auto></li>
			<li>
			<% 
